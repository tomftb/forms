...
function createAccountTypeField(status){
    console.log('createAccountTypeField');
...
function create(){
    ...
    console.log(error);
    error.set('errDiv-Adapted-overall');
    //error.setField(document.getElementById('errDiv-Adapted-overall'));
    //var modalError=document.getElementById('errDiv-Adapted-overall');
   ...
   // modal.setAttribute('data-toggle','modal');
    //return true;
    //data-toggle="modal" data-target="#AdaptedModal"
