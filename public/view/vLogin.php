					...
					<div class="row">
						<div class="col-xl-5 col-sm-5 col-12 pad-right-0 ">
							<div class="logo-back  d-flex flex-wrap align-items-center">
                                                            <img src="<?=APP_URL?>/utilities/autos-logo-clear.svg" width="300px" class="" alt="Logo_Autos">                       
							</div>
						</div>
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="text-left ml-2">
                <small class="text-white"><span id="rozdzielczosc"></span></small>
            </div>
        </div>
  <div class="col-sm-6">
      <div class="text-center">
        <small class="text-white"><?=APP_TITLE?></small>
    </div>
  </div>
  <div class="col-sm-3">
