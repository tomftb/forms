    ...
    <div class="row">
        ...
        <div class="col-6 mb-0 mt-0" >
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Szukaj..." onkeyup="FilledForm.setFilterValue(this)" >
                        <div class="input-group-append">
                            <button class="btn btn-secondary" type="button" onclick="FilledForm.showFilterOut(this)">
                    ...
                    <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" value="0" onclick="FilledForm.showHidden(this)">
                        <small class="text-secondary">Pokaż ukryte</small>
                    </label>
                    </div>
                    <div class="form-group form-check-inline mt-0 ">
                    <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" value="0" onclick="FilledForm.showDeleted(this)">
                        <small class="text-danger">Pokaż usunięte</small>
                    </label>
                    </div>
                    <div class="form-group form-check-inline mt-0 ">
                    <label class="form-check-label">
                        <input type="checkbox" class="form-check-input" value="0" onclick="FilledForm.showAll(this)">
