...
class Filled_form_field_model extends Database_model {
    ...
    public function getByIdForm(int $id_filled_form=0):array{
        return $this->Main->squery('SELECT 
    ...
    public function getNotNullByIdForm(int $id_filled_form=0):array{
        return $this->Main->squery('SELECT 
                        `id_form_field` as `i`
                        ,`value` as `v`
    ...
    public function getByIdFilledFormIdFormField(int $id_filled_form=0,int $id_form_field=0):array{
        return $this->Main->squery('SELECT 
                        `value` as `v`
    ...
    public function getByIdFilledFormNameFormField(int $id_filled_form = 0, string $name="-input-"):array{
        return $this->Main->squery('SELECT 
                        `value` as `v`
