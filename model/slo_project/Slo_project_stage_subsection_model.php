...
class Slo_project_stage_subsection_model extends Database_model {
    ...
    public function insertSection(int $id=0,$id_parent=0):void{
        $this->Main->query2(
    ...
    public function updateDeleteStatus(int $id_parent=0, string $delete_status='1', string $delete_reason='NEW VERSION'):void{
        // AND `delete_status`='0'
    ...
    public function insert(int $id=0,int $id_parent=0):void{
        $this->Main->query2(
            "INSERT INTO `slo_project_stage_subsection` ("
                . "`id`"
                . ",`id_parent`"
                . ",".parent::getUserKey().""
                . ") VALUES ("
