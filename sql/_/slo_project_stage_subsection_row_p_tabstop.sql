...
`id` bigint NOT NULL,
  ...
  `lp` bigint NOT NULL,
  `position` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `measurement` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `measurementName` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `alignment` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `alignmentName` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `leadingSign` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `leadingSignName` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
