...
CREATE TABLE `form_stage_row` (
  ...
  `value` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `name` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `type` enum('text','input','select','checkbox','radio') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'text',
...
--
-- AUTO_INCREMENT for table `form_stage_row`
--
ALTER TABLE `form_stage_row`
...
--
-- Constraints for table `form_stage_row`
--
ALTER TABLE `form_stage_row`
