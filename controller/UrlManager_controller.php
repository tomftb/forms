...
final class UrlManager_controller{
    ...
    private $availableTask=[
        ...
        ['getProjectStages','LOG_INTO_STAGE'],
        ['getProjectDeletedStages','LOG_INTO_STAGE'],
        ['getProjectHiddenStages','LOG_INTO_STAGE'],
        ['getProjectHiddenAndDeletedStages','LOG_INTO_STAGE'],
        ['getProjectAllStages','LOG_INTO_STAGE'],
        ['psCreate','ADD_STAGE'],
        ['psEdit','EDIT_STAGE'],
        ['psDelete','DEL_STAGE'],
        ['psHide','HIDE_STAGE'],
        ...
        ['getProjectConstants','LOG_INTO_STAGE'],
        ['getProjectDeletedConstants','LOG_INTO_STAGE'],
        ['getProjectHiddenConstants','LOG_INTO_STAGE'],
        ['getProjectHiddenAndDeletedConstants','LOG_INTO_STAGE'],
        ['getProjectAllConstants','LOG_INTO_STAGE'],
        ...
        ['getProjectVariables','LOG_INTO_STAGE'],
        ['getProjectHiddenVariables','LOG_INTO_STAGE'],
        ['getProjectDeletedVariables','LOG_INTO_STAGE'],
        ['getProjectHiddenAndDeletedVariables','LOG_INTO_STAGE'],
        ['getProjectAllVariables','LOG_INTO_STAGE'],
