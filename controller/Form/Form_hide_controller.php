<?php
final class Form_stage_hide_controller extends Base_controller {
    ...
    public function getFormStageHideData(){
        $this->Log->log(0,"[".__METHOD__."]");
        ...
        parent::returnJson(
                [
                    ...
                    ,'glossary'=>$this->Controller->{'Slo'}->getByName('fsHide')
                ]
        );
    }
    public function hideFormStage(){
        $this->Log->log(0,"[".__METHOD__."]");
        ...
        $this->Model->{'Form_stage'}->hide($data);
        parent::returnJson([]);
    }
}